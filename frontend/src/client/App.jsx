          ...
          {!isWalletConnected ? (
            <div className="text-center space-y-8 animate-fade-in-up">
              ...
              <div className="space-y-4">
                <h1 className="text-5xl md:text-7xl font-bold text-cyan-400 font-mono">D_ARENA</h1>
                <p className="text-sm md:text-xl text-gray-300 max-w-2xl mx-auto font-mono">
